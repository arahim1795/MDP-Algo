...
public class MapUI extends Map {
    ...
    public void paintComponent(Graphics g) {
        ...
        Border border = BorderFactory.createLineBorder(GraphicConstant.C_GRID_LINE, GraphicConstant.CELL_LINE_WEIGHT);
    ...
    private class ColorTile {
        ...
        public ColorTile (int borderX, int borderY, int borderSize) {
            ...
            this.gridX = borderX + GraphicConstant.CELL_LINE_WEIGHT;
            this.gridY = borderY + GraphicConstant.CELL_LINE_WEIGHT;
            this.gridSize = borderSize - (GraphicConstant.CELL_LINE_WEIGHT * 2);
        }
    }
